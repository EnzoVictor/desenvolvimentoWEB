                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <form action='valida_chamado.php' method='post'>
                                        ...
                                        <? if(isset($_GET['chamado']) && $_GET['chamado'] == 'cancelado'){?>
                                            <script>
                                                Swal.fire({
                                                    type: 'type',
                                                    icon: 'warning',
                                        ...
                                        <? } ?>
                                        <? if(isset($_GET['chamado']) && $_GET['chamado'] == 'enviado'){?>
                                            <script>
                                                Swal.fire({
                                                    type: 'type',
                                                    icon: 'success',
                                                    title: 'Enviado com sucesso',
                                                    text: "A equipe de suporte já recebeu seu chamado e em breve iremos retornar."
